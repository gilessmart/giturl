...
def test__get_git_url__branch_option_with_detached_head(tmp_path):
...
def test__get_git_url__multiple_remotes_and_upstream(tmp_path):
    helpers.repo_create(tmp_path)
    helpers.repo_add_remote(tmp_path, "github", "git@github.com:gilessmart/giturl.git")
    helpers.repo_add_remote(tmp_path, "bitbucket", "git@bitbucket.org:gilessmart/giturl.git")
    helpers.repo_commit_file(tmp_path, "README.md", "hello\n")
...
def test__get_git_url__branch_mode(tmp_path):
    helpers.repo_create(tmp_path, branch="feature-x")
    helpers.repo_add_remote(tmp_path, "origin", "git@github.com:gilessmart/giturl.git")
    helpers.repo_commit_file(tmp_path, "README.md", "hello\n")
...
def test__get_git_url__branch_mode_with_multiple_remotes_and_upstream(tmp_path):
...
def test__get_git_url__line_num_option(tmp_path):
    helpers.repo_create(tmp_path)
    helpers.repo_add_remote(tmp_path, "origin", "git@github.com:gilessmart/giturl.git")
    helpers.repo_commit_file(tmp_path, "README.md", "hello\n")
...
def test__get_git_url__root_level_folder(tmp_path):
    ...
    hash = helpers.repo_get_current_hash(tmp_path)
    assert url == f"https://github.com/gilessmart/giturl/tree/{hash}/"


def test__get_git_url__root_level_file(tmp_path):
    helpers.repo_create(tmp_path)
    helpers.repo_add_remote(tmp_path, "origin", "git@github.com:gilessmart/giturl.git")
    helpers.repo_commit_file(tmp_path, "README.md", "hello\n")
    url = get_git_url(default_config, tmp_path / "README.md")
...
def test__get_git_url__nested_folder(tmp_path):
    helpers.repo_create(tmp_path)
    helpers.repo_commit_file(tmp_path, "a/b/foo.txt", "hello\n")
    helpers.repo_add_remote(tmp_path, "origin", "git@github.com:gilessmart/giturl.git")
    url = get_git_url(default_config, tmp_path / "a/b")
    hash = helpers.repo_get_current_hash(tmp_path)
    assert url == f"https://github.com/gilessmart/giturl/tree/{hash}/a/b"


def test__get_git_url__nested_file(tmp_path):
    helpers.repo_create(tmp_path)
    helpers.repo_commit_file(tmp_path, "a/b/foo.txt", "hello\n")
    helpers.repo_add_remote(tmp_path, "origin", "git@github.com:gilessmart/giturl.git")
...
def test__get_git_url__path_with_special_chars(tmp_path):
    helpers.repo_create(tmp_path)
    helpers.repo_add_remote(tmp_path, "origin", "git@github.com:gilessmart/giturl.git")
...
def test__get_git_url__local_branch_with_special_chars(tmp_path):
...
def test__get_git_url__upstream_branch_with_special_chars(tmp_path):
    helpers.repo_create(tmp_path)
    helpers.repo_add_remote(tmp_path, "origin", "git@github.com:gilessmart/giturl.git")
    helpers.repo_commit_file(tmp_path, "README.md", "hello\n")
